...
def footer():
    ...
    footer += "[\- Website \(Termine eintragen\)](https://klimax.online/bewegungskalender)\n"
    footer += "[\- Andere Kalender\-Projekte](https://pad.kanthaus.online/s/Bewegungskalender#Weitere-Kalender)\n"
    footer += "[\- FAQ und weitere Infos](https://pad.kanthaus.online/s/Bewegungskalender#)\n"
    return footer
