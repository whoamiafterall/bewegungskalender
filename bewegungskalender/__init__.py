...
from bewegungskalender.helper.cli import get_args, set_telegram_channel, set_mail_recipients, set_print_format
...
__all__ =   ([argparse, yaml, locale, logging] +
            ...
            [Format] +
            [get_args, set_print_format, set_telegram_channel, set_mail_recipients] +
            [update_events] +
            [search_events] +
            [get_message] +
